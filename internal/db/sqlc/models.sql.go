...
RETURNING id, model_id, name, llm_provider_id, client_type, dimensions, input_modalities, supports_reasoning, store, type, created_at, updated_at
`
...
SELECT id, model_id, name, llm_provider_id, client_type, dimensions, input_modalities, supports_reasoning, store, type, created_at, updated_at FROM models WHERE id = $1
`
...
SELECT id, model_id, name, llm_provider_id, client_type, dimensions, input_modalities, supports_reasoning, store, type, created_at, updated_at FROM models WHERE model_id = $1
`
...
SELECT id, model_id, name, llm_provider_id, client_type, dimensions, input_modalities, supports_reasoning, store, type, created_at, updated_at FROM models
ORDER BY created_at DESC
`

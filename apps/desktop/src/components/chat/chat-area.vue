    ...
    >
      <div class="text-center">
        ...
        <p class="mt-1 text-sm text-muted-foreground">
          Choose a bot to start chatting
        </p>
      </div>
    </div>
          ...
          <section>
            <InputGroup>
              <InputGroupTextarea
                ...
                :placeholder="activeChatReadOnly ? 'Read-only chat' : 'Type a message...'"
...
import { Button, InputGroup, InputGroupAddon, InputGroupTextarea } from '@memoh/ui'

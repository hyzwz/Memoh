      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <div
            ...
            :class="hand.is_enabled ? 'bg-emerald-500' : 'bg-gray-300'"
          />
          <CardHeader class="pb-2">
            <div class="flex items-center justify-between">
              ...
              <Badge
                :class="hand.is_enabled ? 'bg-emerald-500/10 text-emerald-700 border-emerald-200' : 'bg-muted text-muted-foreground'"
                class="text-xs"
              >
          ...
          <CardContent class="flex-1">
            <div class="flex flex-wrap gap-2">
              ...
              <Badge
                v-if="hand.trigger_type"
                variant="outline"
                class="text-xs border-blue-200 text-blue-700"
              >
        ...
        <div class="space-y-4 mt-4">
          <div class="space-y-1.5">
            ...
            <p class="text-xs text-muted-foreground">
              使用YAML frontmatter定义Hand属性，正文描述功能
            </p>
            <Textarea

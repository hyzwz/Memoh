 ...
 * Create a department
 */
export const postBotsByBotIdDepartmentsMutation = (options?: Partial<Options<PostBotsByBotIdDepartmentsData>>): UseMutationOptions<PostBotsByBotIdDepartmentsResponse, Options<PostBotsByBotIdDepartmentsData>, PostBotsByBotIdDepartmentsError> => ({
    mutation: async (vars) => {
...
export const getBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesQueryKey = (options: Options<GetBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesData>) => createQueryKey('getBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplates', options);

/**
 * Get directory templates for a department
 */
export const getBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesQuery = defineQueryOptions((options: Options<GetBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesData>) => ({
    key: getBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesQueryKey(options),
    query: async (context) => {
        const { data } = await getBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplates({
            ...options,
            ...context,
            throwOnError: true
        });
 ...
 */
export const putBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesMutation = (options?: Partial<Options<PutBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesData>>): UseMutationOptions<unknown, Options<PutBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesData>, PutBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesError> => ({
    mutation: async (vars) => {
        const { data } = await putBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplates({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesQueryKey = (options: Options<GetBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesData>) => createQueryKey('getBotsByBotIdDepartmentsByDepartmentIdSkillTemplates', options);

/**
 * List skill templates assigned to a department
 */
export const getBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesQuery = defineQueryOptions((options: Options<GetBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesData>) => ({
    key: getBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesQueryKey(options),
    query: async (context) => {
        const { data } = await getBotsByBotIdDepartmentsByDepartmentIdSkillTemplates({
            ...options,
            ...context,
            throwOnError: true
        });
 ...
 */
export const postBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesMutation = (options?: Partial<Options<PostBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesData>>): UseMutationOptions<unknown, Options<PostBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesData>, PostBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdDepartmentsByDepartmentIdSkillTemplates({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 */
export const deleteBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesByTemplateIdMutation = (options?: Partial<Options<DeleteBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesByTemplateIdData>>): UseMutationOptions<unknown, Options<DeleteBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesByTemplateIdData>, DeleteBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesByTemplateIdError> => ({
    mutation: async (vars) => {
        const { data } = await deleteBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesByTemplateId({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 */
export const postBotsByBotIdDepartmentsByDepartmentIdSyncDirectoriesMutation = (options?: Partial<Options<PostBotsByBotIdDepartmentsByDepartmentIdSyncDirectoriesData>>): UseMutationOptions<PostBotsByBotIdDepartmentsByDepartmentIdSyncDirectoriesResponse, Options<PostBotsByBotIdDepartmentsByDepartmentIdSyncDirectoriesData>, PostBotsByBotIdDepartmentsByDepartmentIdSyncDirectoriesError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdDepartmentsByDepartmentIdSyncDirectories({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 */
export const postBotsByBotIdDepartmentsByDepartmentIdSyncSkillsMutation = (options?: Partial<Options<PostBotsByBotIdDepartmentsByDepartmentIdSyncSkillsData>>): UseMutationOptions<PostBotsByBotIdDepartmentsByDepartmentIdSyncSkillsResponse, Options<PostBotsByBotIdDepartmentsByDepartmentIdSyncSkillsData>, PostBotsByBotIdDepartmentsByDepartmentIdSyncSkillsError> => ({
    mutation: async (vars) => {
        const { data } = await postBotsByBotIdDepartmentsByDepartmentIdSyncSkills({
            ...options,
            ...vars,
            throwOnError: true
        });

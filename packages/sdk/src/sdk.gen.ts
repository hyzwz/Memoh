 ...
 */
export const postApiV1AuthDesktopLogin = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AuthDesktopLoginData, ThrowOnError>) => (options.client ?? client).post<PostApiV1AuthDesktopLoginResponses, PostApiV1AuthDesktopLoginErrors, ThrowOnError>({
    url: '/api/v1/auth/desktop/login',
    ...options,
    headers: {
 ...
 */
export const getBotsByBotIdAuditLogs = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdAuditLogsData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdAuditLogsResponses, GetBotsByBotIdAuditLogsErrors, ThrowOnError>({ url: '/bots/{bot_id}/audit-logs', ...options });
 ...
 */
export const postBotsByBotIdCockpitGenerateReport = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdCockpitGenerateReportData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdCockpitGenerateReportResponses, PostBotsByBotIdCockpitGenerateReportErrors, ThrowOnError>({ url: '/bots/{bot_id}/cockpit/generate-report', ...options });

/**
 * Get cockpit efficiency summary
 */
export const getBotsByBotIdCockpitSummary = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdCockpitSummaryData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdCockpitSummaryResponses, GetBotsByBotIdCockpitSummaryErrors, ThrowOnError>({ url: '/bots/{bot_id}/cockpit/summary', ...options });
 ...
 */
export const getBotsByBotIdDepartments = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdDepartmentsData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdDepartmentsResponses, GetBotsByBotIdDepartmentsErrors, ThrowOnError>({ url: '/bots/{bot_id}/departments', ...options });

/**
 * Assign a bot to a department
 */
export const postBotsByBotIdDepartments = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdDepartmentsData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdDepartmentsResponses, PostBotsByBotIdDepartmentsErrors, ThrowOnError>({
 ...
 */
export const deleteBotsByBotIdDepartmentsByDepartmentId = <ThrowOnError extends boolean = false>(options: Options<DeleteBotsByBotIdDepartmentsByDepartmentIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteBotsByBotIdDepartmentsByDepartmentIdResponses, DeleteBotsByBotIdDepartmentsByDepartmentIdErrors, ThrowOnError>({ url: '/bots/{bot_id}/departments/{department_id}', ...options });
 ...
 */
export const getBotsByBotIdHands = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdHandsData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdHandsResponses, GetBotsByBotIdHandsErrors, ThrowOnError>({ url: '/bots/{bot_id}/hands', ...options });

/**
 * Create a hand from markdown
 */
export const postBotsByBotIdHands = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdHandsData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdHandsResponses, PostBotsByBotIdHandsErrors, ThrowOnError>({
 ...
 * Delete a hand
 */
export const deleteBotsByBotIdHandsByHandId = <ThrowOnError extends boolean = false>(options: Options<DeleteBotsByBotIdHandsByHandIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteBotsByBotIdHandsByHandIdResponses, DeleteBotsByBotIdHandsByHandIdErrors, ThrowOnError>({ url: '/bots/{bot_id}/hands/{hand_id}', ...options });

/**
 * Get a hand by ID
 */
export const getBotsByBotIdHandsByHandId = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdHandsByHandIdData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdHandsByHandIdResponses, GetBotsByBotIdHandsByHandIdErrors, ThrowOnError>({ url: '/bots/{bot_id}/hands/{hand_id}', ...options });

/**
 * Manually execute a hand
 */
export const postBotsByBotIdHandsByHandIdExecute = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdHandsByHandIdExecuteData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdHandsByHandIdExecuteResponses, PostBotsByBotIdHandsByHandIdExecuteErrors, ThrowOnError>({ url: '/bots/{bot_id}/hands/{hand_id}/execute', ...options });
 ...
 */
export const getBotsByBotIdModelRoutes = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdModelRoutesData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdModelRoutesResponses, GetBotsByBotIdModelRoutesErrors, ThrowOnError>({ url: '/bots/{bot_id}/model-routes', ...options });

/**
 * Create a model route
 */
export const postBotsByBotIdModelRoutes = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdModelRoutesData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdModelRoutesResponses, PostBotsByBotIdModelRoutesErrors, ThrowOnError>({
 ...
 */
export const deleteBotsByBotIdModelRoutesByRouteId = <ThrowOnError extends boolean = false>(options: Options<DeleteBotsByBotIdModelRoutesByRouteIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteBotsByBotIdModelRoutesByRouteIdResponses, DeleteBotsByBotIdModelRoutesByRouteIdErrors, ThrowOnError>({ url: '/bots/{bot_id}/model-routes/{route_id}', ...options });
 ...
 */
export const deleteBotsByBotIdSessionsById = <ThrowOnError extends boolean = false>(options: Options<DeleteBotsByBotIdSessionsByIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteBotsByBotIdSessionsByIdResponses, DeleteBotsByBotIdSessionsByIdErrors, ThrowOnError>({ url: '/bots/{bot_id}/sessions/{id}', ...options });
 ...
 */
export const getBotsByBotIdSkillStore = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdSkillStoreData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdSkillStoreResponses, GetBotsByBotIdSkillStoreErrors, ThrowOnError>({ url: '/bots/{bot_id}/skill-store', ...options });

/**
 * Install a skill template to a bot
 */
export const postBotsByBotIdSkillStoreInstall = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdSkillStoreInstallData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdSkillStoreInstallResponses, PostBotsByBotIdSkillStoreInstallErrors, ThrowOnError>({
 ...
 */
export const postBotsByBotIdSkillStoreUninstall = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdSkillStoreUninstallData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdSkillStoreUninstallResponses, PostBotsByBotIdSkillStoreUninstallErrors, ThrowOnError>({
 ...
 */
export const postBotsByBotIdSkillStoreUpdate = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdSkillStoreUpdateData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdSkillStoreUpdateResponses, PostBotsByBotIdSkillStoreUpdateErrors, ThrowOnError>({
 ...
 * List budgets
 */
export const getBudgets = <ThrowOnError extends boolean = false>(options?: Options<GetBudgetsData, ThrowOnError>) => (options?.client ?? client).get<GetBudgetsResponses, unknown, ThrowOnError>({ url: '/budgets', ...options });

/**
 * Create a budget
 */
export const postBudgets = <ThrowOnError extends boolean = false>(options: Options<PostBudgetsData, ThrowOnError>) => (options.client ?? client).post<PostBudgetsResponses, PostBudgetsErrors, ThrowOnError>({
    url: '/budgets',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * Check budget status
 */
export const getBudgetsCheck = <ThrowOnError extends boolean = false>(options: Options<GetBudgetsCheckData, ThrowOnError>) => (options.client ?? client).get<GetBudgetsCheckResponses, GetBudgetsCheckErrors, ThrowOnError>({ url: '/budgets/check', ...options });

/**
 * Delete a budget
 */
export const deleteBudgetsByBudgetId = <ThrowOnError extends boolean = false>(options: Options<DeleteBudgetsByBudgetIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteBudgetsByBudgetIdResponses, DeleteBudgetsByBudgetIdErrors, ThrowOnError>({ url: '/budgets/{budget_id}', ...options });
 ...
 */
export const getDepartments = <ThrowOnError extends boolean = false>(options?: Options<GetDepartmentsData, ThrowOnError>) => (options?.client ?? client).get<GetDepartmentsResponses, unknown, ThrowOnError>({ url: '/departments', ...options });

/**
 * Create a department
 */
export const postDepartments = <ThrowOnError extends boolean = false>(options: Options<PostDepartmentsData, ThrowOnError>) => (options.client ?? client).post<PostDepartmentsResponses, PostDepartmentsErrors, ThrowOnError>({
    url: '/departments',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 * Delete a department
 */
export const deleteDepartmentsByDepartmentId = <ThrowOnError extends boolean = false>(options: Options<DeleteDepartmentsByDepartmentIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteDepartmentsByDepartmentIdResponses, DeleteDepartmentsByDepartmentIdErrors, ThrowOnError>({ url: '/departments/{department_id}', ...options });

/**
 * Get a department by ID
 */
export const getDepartmentsByDepartmentId = <ThrowOnError extends boolean = false>(options: Options<GetDepartmentsByDepartmentIdData, ThrowOnError>) => (options.client ?? client).get<GetDepartmentsByDepartmentIdResponses, GetDepartmentsByDepartmentIdErrors, ThrowOnError>({ url: '/departments/{department_id}', ...options });

/**
 * Update a department
 */
export const putDepartmentsByDepartmentId = <ThrowOnError extends boolean = false>(options: Options<PutDepartmentsByDepartmentIdData, ThrowOnError>) => (options.client ?? client).put<PutDepartmentsByDepartmentIdResponses, PutDepartmentsByDepartmentIdErrors, ThrowOnError>({
 ...
 */
export const getDepartmentsByDepartmentIdBots = <ThrowOnError extends boolean = false>(options: Options<GetDepartmentsByDepartmentIdBotsData, ThrowOnError>) => (options.client ?? client).get<GetDepartmentsByDepartmentIdBotsResponses, GetDepartmentsByDepartmentIdBotsErrors, ThrowOnError>({ url: '/departments/{department_id}/bots', ...options });

/**
 * Get directory templates for a department
 */
export const getDepartmentsByDepartmentIdDirectoryTemplates = <ThrowOnError extends boolean = false>(options: Options<GetDepartmentsByDepartmentIdDirectoryTemplatesData, ThrowOnError>) => (options.client ?? client).get<GetDepartmentsByDepartmentIdDirectoryTemplatesResponses, GetDepartmentsByDepartmentIdDirectoryTemplatesErrors, ThrowOnError>({ url: '/departments/{department_id}/directory-templates', ...options });

/**
 * Update directory templates for a department
 */
export const putDepartmentsByDepartmentIdDirectoryTemplates = <ThrowOnError extends boolean = false>(options: Options<PutDepartmentsByDepartmentIdDirectoryTemplatesData, ThrowOnError>) => (options.client ?? client).put<PutDepartmentsByDepartmentIdDirectoryTemplatesResponses, PutDepartmentsByDepartmentIdDirectoryTemplatesErrors, ThrowOnError>({
 ...
 */
export const getDepartmentsByDepartmentIdSkillTemplates = <ThrowOnError extends boolean = false>(options: Options<GetDepartmentsByDepartmentIdSkillTemplatesData, ThrowOnError>) => (options.client ?? client).get<GetDepartmentsByDepartmentIdSkillTemplatesResponses, GetDepartmentsByDepartmentIdSkillTemplatesErrors, ThrowOnError>({ url: '/departments/{department_id}/skill-templates', ...options });

/**
 * Add a skill template to a department
 */
export const postDepartmentsByDepartmentIdSkillTemplates = <ThrowOnError extends boolean = false>(options: Options<PostDepartmentsByDepartmentIdSkillTemplatesData, ThrowOnError>) => (options.client ?? client).post<PostDepartmentsByDepartmentIdSkillTemplatesResponses, PostDepartmentsByDepartmentIdSkillTemplatesErrors, ThrowOnError>({
 ...
 */
export const deleteDepartmentsByDepartmentIdSkillTemplatesByTemplateId = <ThrowOnError extends boolean = false>(options: Options<DeleteDepartmentsByDepartmentIdSkillTemplatesByTemplateIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteDepartmentsByDepartmentIdSkillTemplatesByTemplateIdResponses, DeleteDepartmentsByDepartmentIdSkillTemplatesByTemplateIdErrors, ThrowOnError>({ url: '/departments/{department_id}/skill-templates/{template_id}', ...options });

/**
 * Sync directory templates to all bots in a department
 */
export const postDepartmentsByDepartmentIdSyncDirectories = <ThrowOnError extends boolean = false>(options: Options<PostDepartmentsByDepartmentIdSyncDirectoriesData, ThrowOnError>) => (options.client ?? client).post<PostDepartmentsByDepartmentIdSyncDirectoriesResponses, PostDepartmentsByDepartmentIdSyncDirectoriesErrors, ThrowOnError>({ url: '/departments/{department_id}/sync-directories', ...options });

/**
 * Sync skill templates to all bots in a department
 */
export const postDepartmentsByDepartmentIdSyncSkills = <ThrowOnError extends boolean = false>(options: Options<PostDepartmentsByDepartmentIdSyncSkillsData, ThrowOnError>) => (options.client ?? client).post<PostDepartmentsByDepartmentIdSyncSkillsResponses, PostDepartmentsByDepartmentIdSyncSkillsErrors, ThrowOnError>({ url: '/departments/{department_id}/sync-skills', ...options });
 ...
 */
export const getSkillTemplates = <ThrowOnError extends boolean = false>(options?: Options<GetSkillTemplatesData, ThrowOnError>) => (options?.client ?? client).get<GetSkillTemplatesResponses, GetSkillTemplatesErrors, ThrowOnError>({ url: '/skill-templates', ...options });

/**
 * Create a skill template
 */
export const postSkillTemplates = <ThrowOnError extends boolean = false>(options: Options<PostSkillTemplatesData, ThrowOnError>) => (options.client ?? client).post<PostSkillTemplatesResponses, PostSkillTemplatesErrors, ThrowOnError>({
    url: '/skill-templates',
    ...options,
    headers: {
        'Content-Type': 'application/json',
 ...
 */
export const deleteSkillTemplatesById = <ThrowOnError extends boolean = false>(options: Options<DeleteSkillTemplatesByIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteSkillTemplatesByIdResponses, DeleteSkillTemplatesByIdErrors, ThrowOnError>({ url: '/skill-templates/{id}', ...options });

/**
 * Get a skill template by ID
 */
export const getSkillTemplatesById = <ThrowOnError extends boolean = false>(options: Options<GetSkillTemplatesByIdData, ThrowOnError>) => (options.client ?? client).get<GetSkillTemplatesByIdResponses, GetSkillTemplatesByIdErrors, ThrowOnError>({ url: '/skill-templates/{id}', ...options });

/**
 * Update a skill template
 */
export const putSkillTemplatesById = <ThrowOnError extends boolean = false>(options: Options<PutSkillTemplatesByIdData, ThrowOnError>) => (options.client ?? client).put<PutSkillTemplatesByIdResponses, PutSkillTemplatesByIdErrors, ThrowOnError>({

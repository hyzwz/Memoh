 ...
 */
export const getBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplates = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesResponses, GetBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesErrors, ThrowOnError>({ url: '/bots/{bot_id}/departments/{department_id}/directory-templates', ...options });

/**
 * Update directory templates for a department
 */
export const putBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplates = <ThrowOnError extends boolean = false>(options: Options<PutBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesData, ThrowOnError>) => (options.client ?? client).put<PutBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesResponses, PutBotsByBotIdDepartmentsByDepartmentIdDirectoryTemplatesErrors, ThrowOnError>({
 ...
 */
export const getBotsByBotIdDepartmentsByDepartmentIdSkillTemplates = <ThrowOnError extends boolean = false>(options: Options<GetBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesData, ThrowOnError>) => (options.client ?? client).get<GetBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesResponses, GetBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesErrors, ThrowOnError>({ url: '/bots/{bot_id}/departments/{department_id}/skill-templates', ...options });

/**
 * Add a skill template to a department
 */
export const postBotsByBotIdDepartmentsByDepartmentIdSkillTemplates = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesResponses, PostBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesErrors, ThrowOnError>({
 ...
 */
export const deleteBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesByTemplateId = <ThrowOnError extends boolean = false>(options: Options<DeleteBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesByTemplateIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesByTemplateIdResponses, DeleteBotsByBotIdDepartmentsByDepartmentIdSkillTemplatesByTemplateIdErrors, ThrowOnError>({ url: '/bots/{bot_id}/departments/{department_id}/skill-templates/{template_id}', ...options });

/**
 * Sync directory templates to all bots in a department
 */
export const postBotsByBotIdDepartmentsByDepartmentIdSyncDirectories = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdDepartmentsByDepartmentIdSyncDirectoriesData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdDepartmentsByDepartmentIdSyncDirectoriesResponses, PostBotsByBotIdDepartmentsByDepartmentIdSyncDirectoriesErrors, ThrowOnError>({ url: '/bots/{bot_id}/departments/{department_id}/sync-directories', ...options });

/**
 * Sync skill templates to all bots in a department
 */
export const postBotsByBotIdDepartmentsByDepartmentIdSyncSkills = <ThrowOnError extends boolean = false>(options: Options<PostBotsByBotIdDepartmentsByDepartmentIdSyncSkillsData, ThrowOnError>) => (options.client ?? client).post<PostBotsByBotIdDepartmentsByDepartmentIdSyncSkillsResponses, PostBotsByBotIdDepartmentsByDepartmentIdSyncSkillsErrors, ThrowOnError>({ url: '/bots/{bot_id}/departments/{department_id}/sync-skills', ...options });
